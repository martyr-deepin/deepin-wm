...
namespace Gala
{
	...
	public class DeepinCssActor : Actor
	{
		...
		construct
		{
			bg_color_normal = DeepinUtils.get_css_background_rgba (style_class);
			bg_color_selected = DeepinUtils.get_css_background_rgba (style_class, Gtk.StateFlags.SELECTED);
